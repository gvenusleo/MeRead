...
extension FolderQueryLinks on QueryBuilder<Folder, Folder, QFilterCondition> {
  QueryBuilder<Folder, Folder, QAfterFilterCondition> feeds(
      FilterQuery<Feed> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'feeds', 0, true, 0, true);
    });
  }

  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'feeds', 0, false, 999999, true);
    });
  }

  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> feedsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
